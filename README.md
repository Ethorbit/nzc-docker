...
## Prerequisites
* a Linux install (outside of a container) with at least 4 CPU threads (for best performance), NVMe storage (For best performance) with at least 25GB of free disk space, and at least 3GB of RAM available.
* a domain
